"! This class is used to fill travel data into the table zrap100_atravtho
CLASS zcl_rap100_gen_data_tho DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_tho IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'tho',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravtho.
*    DELETE FROM zrap100_dtravtho.

    "insert travel demo data
    INSERT zrap100_atravtho  FROM (
        SELECT
